...
public class BaseExceptionTest {
    ...
    public void multiple_causes_should_be_visible() throws Exception {
        ...
        BaseException.wrap(TotoException.class, BaseException.wrap(TotoException.class, new RuntimeException("yop"), TotoErrorCode.CARAMBAR_MODE), TotoErrorCode.JOKE_MODE).printStackTrace(new PrintWriter(stringWriter));
        String text = stringWriter.toString();

        assertThat(text).contains("Caused by: java.lang.RuntimeException: yop");
        assertThat(text).contains("Caused by: org.seedstack.shed.exception.BaseExceptionTest$TotoException: [TOTO] Carambar mode");
