...
public class TextUtilsTest {
    private String longString = "Nec vox accusatoris ulla licet subditicii in his malorum quaerebatur acervis ut " +
            "saltem specie tenus crimina praescriptis legum committerentur, quod aliquotiens fecere principes saevi: " +
            "sed quicquid Caesaris implacabilitati sedisset, id velut fas iusque perpensum confestim urgebatur " +
            "impleri.";
